...
jQuery(function($) {
	...
	$('#simpan').on('click', function(e) {
		e.preventDefault();
		if (confirm('Anda yakin akan mengupdate data ini !?') == false) {
			return false;
		}
...
<tr>
	...
	<td><input type="text" name="harga_bangunan" id="harga_bangunan" value="<?php if(!isset($harga_bangunan)){$harga_bangunan = 0;}echo to_money(intval($harga_bangunan)); ?>" size="20"></td>
</tr>
