...
jQuery(function($) {
	...
	$('#delete').on('click', function(e) {
		...
		var url		= this_base + 'harga_tanah_proses_delete.php',
			data	= $('#form').serialize();
...
<tr>
	...
	<td><input type="text" name="harga_tanah" id="harga_tanah" value="<?php if(!isset($harga_tanah)){$harga_tanah = 0;}echo to_money(intval($harga_tanah)); ?>" size="15"></td>
</tr>
