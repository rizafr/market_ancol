...
function loadData() {
	...
	jQuery('#data-load').load(this_base + 'tipe_load.php', data);
	return false;
}

function showPopup(act, id) {
	var url = this_base + 'tipe_popup.php?act=' + act + '&id=' + id;
	setPopup(act + ' Tipe', url, 410, 170);
	return false;
}

function hapusData()
{	
	var url		= base_marketing + 'master/tipe/tipe_proses.php?act=Hapus',
...
<div class="title-page">DAFTAR TIPE BANGUNAN</div>
...
<tr>
	...
	<td>
		<select name="s_opf1" id="s_opf1" class="auto">
			...
			<option value="TIPE_BANGUNAN"> TIPE BANGUNAN </option>
		</select>
