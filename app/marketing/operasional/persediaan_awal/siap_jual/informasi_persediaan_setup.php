...
function loadData() {
	...
	jQuery('#data-load').load(base_marketing_transaksi + 'informasi_persediaan/informasi_persediaan_load.php', data);
	return false;
}

function showPopup(act, id) {
	var url = base_marketing_transaksi + 'informasi_persediaan/informasi_persediaan_popup.php?act=' + act + '&id=' + id;
	setPopup('Edit Data Stok Persediaan', url, 900, 600);
	return false;
}
...
<div class="title-page">EDIT INFORMASI SIAP JUAL</div>
