...
<tr>
	...
	<th>KODE BLOK</th>
	<th >LUAS <br /> SEMI GROSS (M&sup2;)</th>
	<th>TOWER</th>
	<th>JENIS UNIT</th>	
	<th>TIPE</th>
...
jQuery(function($) {
	...
	*/
	$(document).on('click', 'tr.onclick td:not(.notclick)', function(e) {
		...
		showPopup2('Detail', id);
		return false;
	});
	
	$('#reserve').on('click', function(e) {
		e.preventDefault();		
		parent.showPopup2('Reserve', '<?php echo $id; ?>');
		return false;
	});
...
function showPopup2(act, id) {
	...
	setPopup('Edit Informasi Persediaan', url, 800, 500);
	return false;
}

function showPopup7(act, id, nm, alamat, no_va, telepon)
{
	var url = base_+ 'reserve/spp_popup.php' + '?act=' + act + '&id=' + id + '&nm=' + nm + '&alamat=' + alamat + '&no_va=' + no_va + '&telepon=' + telepon;
	setPopup(act + ' SPP', url, 830, 800);	
	return false;
}
