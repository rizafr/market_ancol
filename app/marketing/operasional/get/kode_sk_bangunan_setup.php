...
<div class="title-page">DAFTAR HARGA SK</div>
...
<form name="form" id="form" method="post">
		...
		<tr>
			...
			<td>
				<select name="field1" id="field1" class="wauto">
					...
					<option value="KODE_SK"> HARGA SK </option>
				</select>
				<input type="text" name="search1" id="search1" class="apply" value="<?= $id?>">
			</td>
		</tr>
		<tr>
	...
	<script type="text/javascript">
		...
		function loadData()
		{
			...
			jQuery('#t-detail').load(get_base + 'kode_sk_bangunan_load.php', data);
			return false;
		}
