<?php
require_once('persediaan_siap_jual_proses.php');
...
var this_base = base_marketing + 'operasional/persediaan_siap_jual/';
...
jQuery(function($) {
	...
	$('#simpan').on('click', function(e) {
		e.preventDefault();
		var url		= this_base + 'persediaan_siap_jual_proses.php',
			data	= $('#form').serialize();
...
<tr>
	...
	<td><input readonly="readonly" type="text" name="kode_blok" id="kode_blok" size="10" value="<?php echo $kode_blok; ?>"></td>
</tr>
<tr>
	<td>Desa</td><td>:</td>
	<td>
		<input readonly="readonly" type="text" name="kode_desa" id="kode_desa" size="1" value="<?php echo $kode_desa; ?>">
		<button onclick="return get_kode_desa()"> > </button>
		<input readonly="readonly" type="text" id="nama_desa" size="25" value="<?php echo $nama_desa; ?>">
	</td>
</tr>
<tr>
	<td>Lokasi</td><td>:</td>
	<td>
		<input readonly="readonly" type="text" name="kode_lokasi" id="kode_lokasi" size="1" value="<?php echo $kode_lokasi; ?>">
		<button onclick="return get_kode_lokasi()"> > </button>
		<input readonly="readonly" type="text" id="lokasi" size="25" value="<?php echo $lokasi; ?>">
	</td>
</tr>
<tr>
	<td>Jenis Unit</td><td>:</td>
	<td>
		<input readonly="readonly" type="text" name="kode_unit" id="kode_unit" size="1" value="<?php echo $kode_unit; ?>">
		<button onclick="return get_kode_unit()"> > </button>
		<input readonly="readonly" type="text" id="jenis_unit" size="25" value="<?php echo $jenis_unit; ?>">
	</td>
</tr>
<tr>
	<td>SK. Tanah</td><td>:</td>
	<td>
		<input readonly="readonly" type="text" name="kode_sk_tanah" id="kode_sk_tanah" size="1" value="<?php echo $kode_sk_tanah; ?>">
		<button onclick="return get_kode_sk_tanah()"> > </button>
		<input readonly="readonly" type="text" id="harga_tanah_sk" class="text-right" size="15" value="<?php echo to_money($harga_tanah_sk); ?>"> / M&sup2;
	</td>
</tr>
<tr>
	<td>Faktor Strategis</td><td>:</td>
	<td>
		<input readonly="readonly" type="text" name="kode_faktor" id="kode_faktor" size="1" value="<?php echo $kode_faktor; ?>">
		<button onclick="return get_kode_faktor()"> > </button>
		<input readonly="readonly" type="text" id="faktor_strategis" size="25" value="<?php echo $faktor_strategis; ?>">
	</td>
</tr>
<tr>
	<td>Tipe</td><td>:</td>
	<td>
		<input readonly="readonly" type="text" name="kode_tipe" id="kode_tipe" size="1" value="<?php echo $kode_tipe; ?>">
		<button onclick="return get_kode_tipe()"> > </button>
		<input readonly="readonly" type="text" id="tipe_bangunan" size="25" value="<?php echo $tipe_bangunan; ?>">
	</td>
</tr>
<tr>
	<td>SK. Bangunan</td><td>:</td>
	<td>
		<input readonly="readonly" type="text" name="kode_sk_bangunan" id="kode_sk_bangunan" size="1" value="<?php echo $kode_sk_bangunan; ?>">
		<button onclick="return get_kode_sk_bangunan()"> > </button>
		<input readonly="readonly" type="text" id="harga_bangunan_sk" class="text-right" size="15" value="<?php echo to_money($harga_bangunan_sk); ?>"> / M&sup2;
	</td>
</tr>
<tr>
	<td>Jenis Penjualan</td><td>:</td>
	<td>
		<input readonly="readonly" type="text" name="kode_penjualan" id="kode_penjualan" size="1" value="<?php echo $kode_penjualan; ?>">
		<button onclick="return get_kode_penjualan()"> > </button>
		<input readonly="readonly" type="text" id="jenis_penjualan" size="25" value="<?php echo $jenis_penjualan; ?>">
	</td>
</tr>
</table>
...
<tr>
	...
	<td><b>Rp. </b><input readonly="readonly" type="text" class="bold text-right" value="<?php echo to_money($harga_tanah + $harga_bangunan); ?>"></td>
</tr>
<tr>
