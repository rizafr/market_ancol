...
var this_base = base_marketing + 'utilitas/security_management/manage_menus/';
...
jQuery(function($) {
	...
	$(document).on('click', '#tambah', function(e) {
		...
		var url		= this_base + 'manage_menus_proses.php',
			data	= $('#form').serialize();
...
function loadData() {
	...
	jQuery('#data-load').load(this_base + 'manage_menus_load.php', data);
	return false;
}
...
<div class="title-page">SECURITY MANAGEMENT (MANAGE MENUS)</div>
