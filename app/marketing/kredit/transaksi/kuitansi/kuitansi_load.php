...
<tr>
	<th class="w15">CUSTOMER ID</th>
	<th class="w15">BLOK / NOMOR</th>
	<th class="w30">NAMA PEMBELI</th>
	<th class="w15">NO. VIRTUAL ACCOUNT</th>
	<th class="w15">TOTAL KWT BELUM PRINT</th>
</tr>
...
if ($total_data > 0)
{
	...
	while( ! $obj->EOF)
	{
		...
		<tr class="onclick" id="<?php echo $id; ?>"> 
			...
			<?php $query2 = "SELECT COUNT(KODE_BLOK) AS TOTAL FROM KWITANSI WHERE KODE_BLOK = '$id' AND STATUS_KWT = 0";
			$obj2 = $conn->execute($query2);
			?>
			
			<td class="text-center"><?php echo $obj2->fields['TOTAL'].' transaksi';  ?></td>
		</tr>
		<?php
		$obj->movenext();
	}
