<?php
require_once('kuitansi_tanda_jadi_proses.php');
...
//==============================================	
	...
	$('#print').on('click', function(e) {
		...
		window.open(base_marketing + 'kredit/transaksi/kuitansi/kuitansi_tanda_jadi_print.php?id=<?php echo base64_encode($id); ?>&catatan_kwt=' + cat_kwt);
		return false;
	});	
	calculate();
	cal2();
...
<tr id="tr-jp">
	...
	<select name="jenis_pembayaran" id="jenis_pembayaran">
		...
		while( ! $obj->EOF)
		{
			...
			echo "<option value='$ov' data-jenis='$oj' selected> $oj </option>";
			$obj->movenext();
		}
		?>
	</select>
...
<tr>
	...
	<td colspan="2"><input type="text" name="nama_pembayar" id="nama_pembayar" size="50" value="<?php echo $nama_pembayar; ?>" readonly="readonly"></td>
</tr>
<tr>
