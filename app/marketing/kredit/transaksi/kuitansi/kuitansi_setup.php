...
<tr>
	...
	<td>
		<select name="field1" id="field1" class="wauto">
			...
			<option value="NOMOR_CUSTOMER"> NO. KARTU PEMBELI </option>
		</select>
...
function loadData()
{
	...
	jQuery('#t-detail').load(base_marketing + 'kredit/transaksi/kuitansi/kuitansi_load.php', data);	
	return false;
}
...
function showPopup(act, id)
{
	...
	setPopup('Kuitansi Penjualan Unit Kaveling / Bangunan', url, 1200, 550);	
	return false;
}
</script>
