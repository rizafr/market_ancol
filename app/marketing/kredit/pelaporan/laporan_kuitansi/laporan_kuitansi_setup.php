<div class="title-page">DAFTAR KUITANSI PENJUALAN UNIT KAVELING / BANGUNAN</div>
...
jQuery(function($) {
	...
	$(document).on('click', '#excel', function(e) {
		e.preventDefault();
		location.href = base_marketing + 'kredit/pelaporan/laporan_kuitansi/print_report_kuitansi.php?' + $('#form').serialize();
		return false;
	});
	
	$(document).on('click', '#print', function(e) {
		e.preventDefault();
		var url = base_marketing + 'kredit/pelaporan/laporan_kuitansi/print_report_kuitansi.php?' + $('#form').serialize();
		open_print(url)
		return false;
	});
...
function loadData()
{
	...
	jQuery('#t-detail').load(base_marketing + 'kredit/pelaporan/laporan_kuitansi/laporan_kuitansi_load.php', data);	
	return false;
}
</script>
