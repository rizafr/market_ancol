...
<tr>
	...
	<td>
		<input type="text" name="periode" id="periode" class="apply mm-yyyy" size="15" value="">
	</td>
</tr>
<tr>
	<td>Otorisasi SPP</td><td>:</td>
	<td>
		<input type="radio" name="status_otorisasi" id="sba" class="status" value="2" checked="true"> <label for="sba">Semua</label>
		<input type="radio" name="status_otorisasi" id="sbb" class="status" value="0"> <label for="sbb">Belum</label>
