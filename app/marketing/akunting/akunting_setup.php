...
jQuery(function($) {
	...
	$(document).on('click', '#excel', function(e) {
		e.preventDefault();
		location.href = base_marketing_akunting + 'akunting_excel.php?' + $('#form').serialize();
		return false;
	});
	
	$(document).on('click', '#print', function(e) {
		e.preventDefault();
		window.open(base_marketing_akunting + 'akunting_print.php?' + $('#form').serialize());
		return false;
	});
...
function loadData()
{
	...
	jQuery('#t-detail').load(base_marketing_akunting + 'akunting_load.php', data);	
	return false;
}
