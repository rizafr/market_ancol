<div class="title-page">ORLANSOFT</div>
...
jQuery(function($) {
	...
	$(document).on('click', '#excel', function(e) {
		e.preventDefault();
		location.href = base_marketing + 'collection_tunai/laporan/orlansoft/excel_orlansoft.php?' + $('#form').serialize();
		return false;
	});
	
	$(document).on('click', '#print', function(e) {
		e.preventDefault();
		window.open(base_marketing + 'collection_tunai/laporan/orlansoft/print_orlansoft.php?' + $('#form').serialize());
		return false;
	});
...
function loadData()
{
	...
	jQuery('#t-detail').load(base_marketing + 'collection_tunai/laporan/orlansoft/orlansoft_load.php', data);	
	return false;
}
