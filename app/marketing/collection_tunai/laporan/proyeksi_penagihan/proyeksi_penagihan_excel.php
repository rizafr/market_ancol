...
<table border="1">
    <tr>
        <td colspan="10" class="nb text-center"><b> LAPORAN PROYEKSI PENAGIHAN</b></td>
    </tr>
    <tr>
        <td colspan="10" class="nb text-center">
            Periode <?php echo kontgl(date("d M Y", strtotime($periode_awal))) . ' s/d ' . kontgl(date("d M Y", strtotime($periode_akhir))) ?> </td>
        </tr>
        ...
        <?php
        $nama_file = "LAPORAN PROYEKSI PENAGIHAN.xls";
