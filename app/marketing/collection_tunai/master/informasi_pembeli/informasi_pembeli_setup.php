<div class="title-page">DATA CUSTOMER</div>
...
function loadData()
{
	...
	jQuery('#t-detail').load(base_marketing + 'collection_tunai/master/informasi_pembeli/informasi_pembeli_load.php', data);	
	return false;
}
...
function hapusData()
{	
	var url		= base_marketing + 'collection_tunai/master/informasi_pembeli/informasi_pembeli_proses.php?act=Hapus',
