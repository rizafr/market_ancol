...
<?php
	$query = "
	SELECT a.NOMOR_KWITANSI, a.TANGGAL, a.NAMA_PEMBAYAR, a.KETERANGAN, a.NILAI, a.NILAI_DIPOSTING, a.VER_COLLECTION, a.VER_KEUANGAN FROM 
	KWITANSI a LEFT JOIN SPP s ON a.KODE_BLOK = s.KODE_BLOK
