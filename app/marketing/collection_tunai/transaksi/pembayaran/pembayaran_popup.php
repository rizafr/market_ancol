...
jQuery(function($) {
	...
	$('#cancel').on('click', function(e) {
		e.preventDefault();
		var total = jQuery('#total_identifikasi').val();
		if(total!='0'){
			alert('Pengembalian dapat dilakukan jika tidak terdapat tagihan yang bisa diidentifikasi');
			return false;
		}

		var id			= '<?php echo $id; ?>';
		var kode		= '<?php echo $kode_blok; ?>';
		jQuery('#act').val('Pengembalian');
...
<table class="t-popup w50 f-left" style="margin-right:35px">
	...
	<tr>
		...
		<td>
			...
			<input type="hidden" name="nama_pembeli" id="nama_pembeli" value="<?php echo $nama_pembeli; ?>">
			<input type="hidden" name="kode_bank" id="kode_bank" value="<?php echo $kode_bank; ?>">
		</td>
	</tr>
	<tr>
...
<tr>
	...
	<td><?php echo $nomor_va; ?><input type="hidden" name="no_va" value="<?php echo $nomor_va;?>"></td>
</tr>
<tr>
...
<tr>
	<td>TANGGAL TRANSAKSI</td></td><td>:</td>
	<td><b><?php echo $tanggal_bayar; ?></b></td>
</tr>
<tr>
	<td>BANK</td></td><td>:</td>
	<td><b><?php echo $nama_bank; ?></b></td>
</tr>
<tr>
...
<tr>
	<td>
		...
		<input type="button" id="cancel" value=" Pengembalian ">
		<input type="button" id="close" value=" Tutup " onclick="jQuery('#popup_close').click();">
	</td>
</tr>
</table>
