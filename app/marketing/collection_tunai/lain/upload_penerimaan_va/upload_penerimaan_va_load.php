...
<table class="t-data w50">
	...
	<?php
		...
		{
			$query = "
			SELECT NOMOR_VA,TANGGAL,NILAI, NAMA_BANK
			FROM 
			PEMBAYARAN p LEFT JOIN BANK b
			on p.KODE_BANK = b.KODE_BANK
			$query_search 
			ORDER BY NOMOR_VA
			";
			...
			<tr id="<?php echo $id; ?>"> 
				...
				<td class="text-center"><?php echo clean($obj->fields['NAMA_BANK']); ?></td>
			</tr>
			<?php
				$obj->movenext();
			}
