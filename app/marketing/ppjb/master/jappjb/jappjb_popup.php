<?php
require_once('jappjb_proses.php');
?>
...
<head>
	...
	<script type="text/javascript">
		$(function() {
			...
			$('#nama_file').inputmask('varchar', { repeat: '200' });
			...
			// 	e.preventDefault();
			// 	var url		= base_marketing + 'ppjb/master/jappjb/jappjb_proses.php',
			// 	data	= $('#form').serialize();
