...
function showPopup1(act, id) {
	...
	setPopup(act + ' Persediaan Awal', url, 835, 550);
	return false;
}
...
function showPopup2(act, id) {
	...
	setPopup('Informasi Persediaan', url, 650, 470);
	return false;
}
...
<div class="title-page">RESERVE</div>
