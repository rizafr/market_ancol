...
if ($kode != '')
{
	$query_search .= " WHERE KODE_BLOK = '$kode' ";
}
...
<tr>
	...
	<th class="w15">NO. VA</th>
	<th class="w15">BLOK / NOMOR</th>
	<th class="w30">PIHAK PERTAMA</th>
	<th class="w30">TANGGAL PENGALIHAN HAK</th>
</tr>
...
if ($total_data > 0)
{
	...
	while( ! $obj->EOF)
	{
		...
		<tr> 
			...
			<td><?php echo $obj->fields['NO_VA_PH'];  ?></td>
