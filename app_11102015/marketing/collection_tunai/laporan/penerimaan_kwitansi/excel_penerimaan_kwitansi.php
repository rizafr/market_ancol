...
if ($total_data > 0)
{
	...
	while( ! $obj->EOF)
	{
		...
		$subtotal = $obj->fields['NILAI_PPN'] + $obj->fields['NILAI'];
		$total_ppn += $obj->fields['NILAI_PPN'];
		$total_nilai += $obj->fields['NILAI'];
	...
	echo'
		<tr> 
			...
			<th class="text-right"><b>'.to_money($total_nilai).'</b></th>
			<th class="text-right">0</th>			
			<th class="text-right"><b>'.to_money($total_ppn).'</b></th>		
			<th class="text-right"><b>'.to_money($total_total).'</b></th>		
		</tr>';
}
?>
</table>
