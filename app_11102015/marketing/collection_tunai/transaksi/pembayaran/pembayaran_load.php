...
<tr>
	...
	<th class="w15">VIRTUAL ACCOUNT</th>
	<th class="w15">TANGGAL TRANSAKSI</th>
	<th class="w15">NILAI TRANSAKSI</th>
	<th class="w20">BANK</th>
</tr>
...
{
	$query = "
	SELECT a.KODE_BLOK, a.NAMA_PEMBELI, b.NOMOR_VA, b.TANGGAL, b.NILAI, c.NAMA_BANK
	FROM PEMBAYARAN b LEFT JOIN SPP a  
	ON a.NOMOR_CUSTOMER = b.NOMOR_VA
	LEFT JOIN BANK c 
	on b.KODE_BANK = c.KODE_BANK
	WHERE b.STATUS = '0'
	$query_search
	...
	while( ! $obj->EOF)
	{
		...
		?>
		<tr class="onclick" id="<?php echo $id; ?>" tgl = "<?php echo tgltgl(date('d-m-Y', strtotime($obj->fields['TANGGAL']))); ?>">
			...
			<td class="text-center"><?php echo $obj->fields['NAMA_BANK']; ?></td>
		</tr>
		<?php
		$i++;
		$obj->movenext();
