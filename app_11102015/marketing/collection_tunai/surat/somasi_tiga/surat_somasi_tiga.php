<?php
	...
	if($act == 'Surat') #Proses Hapus
	{
		...
		{	
			...
			$nama_file = "Surat_Somasi_III_".trim($kode_blok)."_".date('d F Y').".doc";
		...
		$zip_file_name="Surat_Somasi_III_".date('d F Y').".zip";
		$file_path= getcwd(). '/Surat_Somasi_III/';
