<div class="title-page">IMPORT PENERIMAAN VIRTUAL ACCOUNT</div>

<form name="form" id="form" method="post">
<table class="t-control">
<tr>
	<td width="100">VIRTUAL ACCOUNT</td><td width="10">:</td>
	<td>
		<input type="text" size="43" name="no_va" id="no_va" class="apply" value="">
	</td>
</tr>
<tr>	
	<td>Periode</td><td>:</td>
...
function loadData()
{
	...
	jQuery('#t-detail').load(base_marketing + 'collection_tunai/lain/upload_penerimaan_va/upload_penerimaan_va_load.php', data);
	return false;
}

function showPopup(act, id)
{
	var url =	base_marketing + 'collection_tunai/lain/upload_penerimaan_va/import_setup.php' + '?act=' + act + '&id=' + id;
	setPopup('Import Data Pembayaran Virtual Account', url, 700, 300);
	return false;
}

function hapusData()
{	
	var url		= base_marketing + 'collection_tunai/lain/upload_penerimaan_va/upload_penerimaan_va_proses.php?act=Hapus',
