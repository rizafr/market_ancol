...
<tr>
	<td class="text-left"><b>No Virtual Account :<input type="text" name="no_customer" id="no_customer" size="20" value="<?php echo $no_va; ?>"></td>
...
<tr>
	...
	<td><input type="text" name="tlp_lain" id="tlp_lain" size="30" value="<?php echo $telepon; ?>"></td>
</tr>
</table>
...
<tr>
	<td width="290">Identitas<span class="error">*</span> :
		<input type="radio" name="identitas" id="ktp" value="1" <?php echo is_checked('1', $identitas); ?> checked>KTP
