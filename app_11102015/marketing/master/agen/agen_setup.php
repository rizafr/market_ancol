...
function loadData() {
	...
	jQuery('#data-load').load(this_base + 'agen_load.php', data);
	return false;
}

function showPopup(act, id, nm) {
	var url = this_base + 'agen_popup.php?act=' + act + '&id=' + id + '&nm=' + nm;
	setPopup(act + ' Agen', url, 700, 450);
	return false;
}

function hapusData()
{	
	var url		= base_marketing + 'master/agen/agen_proses.php?act=Hapus',
