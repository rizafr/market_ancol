...
<tr>
	...
	<th class="w5">KODE</th>
	<th class="w35">PEMBAYARAN</th>
	<th class="w15">TIPE</th>
	<th class="w15">INISIAL</th>
</tr>
...
if ($total_data > 0)
{
	...
	while( ! $obj->EOF)
	{
		...
		$nm = $obj->fields['JENIS_BAYAR'];
		$tp = $obj->fields['KELOMPOK'];
		$ni = $obj->fields['INISIAL'];
		...
		<tr class="onclick" id="<?php echo $id; ?>"> 
			...
			<td><?php echo $obj->fields['KELOMPOK']; ?></td>
			<td><?php echo $obj->fields['INISIAL']; ?></td>
		</tr>
		<?php
		$obj->movenext();
	}
